...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener imgButtonHanlder=new View.OnClickListener()
    {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog diaBox = new AlertDialog.Builder(MainActivity.this)
                        .setTitle("서버 열기")
                        .setMessage(serverName+ " 서버를 여시겠습니까?")
                        .setPositiveButton("서버열기", new DialogInterface.OnClickListener() {
